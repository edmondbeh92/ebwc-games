...
export const Content = () => (
    ...
    <div class='container text-center'>
        <img src={require("../../images/ebwc_weblogo.png")} alt="EBWC_Logo" class='ebwc-img' />
        <br />
        <hr />
        <div class='text-justify text-color-three py-5'>
            <h4>
                ...
                I had tried making a 2D vertical shmup called <strong class='text-light'>Celestial Raid</strong>.
